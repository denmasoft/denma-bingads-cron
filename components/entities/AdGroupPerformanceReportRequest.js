module.exports = (sequelize, DataTypes) => {
    const AdGroupPerformanceReportRequest = sequelize.define('AdGroupPerformance', {
        AdGroup_Id: {
        ...
        AdGroupLabels : {type: DataTypes.STRING},
    ...
    AdGroupPerformanceReportRequest.associate = models => {}
